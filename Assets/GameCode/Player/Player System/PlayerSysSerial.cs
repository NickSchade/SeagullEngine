...
public class PlayerSysSerial : IPlayerSys
{
    HomelandsGame _game;
    ...
    public PlayerSysSerial(HomelandsGame game, int numPlayers)
    {
        _game = game;
    ...
    public void AddPlayer()
    {
        ...
        Player newPlayer = new Player(_game, demo, _game._settings._playerSettings._buildQueueType);
